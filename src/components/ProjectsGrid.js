      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {items.map((project, idx) => (
          <a
            key={idx}
            href={project.url}
            className="group block card p-5 hover:-translate-y-0.5 hover:shadow-md hover:border-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 transition-colors no-underline hover:no-underline decoration-transparent hover:decoration-transparent text-inherit"
          >
